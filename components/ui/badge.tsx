  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        brand:
          "border-transparent bg-brand-gradient text-brand-foreground shadow-sm hover:opacity-95",
        success:
        ...
        error:
          "border-transparent bg-error text-error-foreground hover:bg-error/85",
        info: "border-transparent bg-info text-info-foreground hover:bg-info/85",
        live: "border-transparent bg-error text-error-foreground shadow-sm hover:bg-error/85",
