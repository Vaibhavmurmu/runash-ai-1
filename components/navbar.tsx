                ...
                <div className="absolute left-0 top-10 w-[540px] rounded-xl border border-orange-100 bg-white p-4 shadow-2xl dark:border-orange-900/30 dark:bg-gray-900">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <Link href="/ai-agents" className="block rounded-md px-3 py-2 text-gray-700 hover:bg-orange-50 hover:text-orange-600 dark:text-gray-300 dark:hover:bg-orange-900/20">Agents</Link>
