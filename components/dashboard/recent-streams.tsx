                ...
                <div className="relative">
                  <Avatar className="h-10 w-10 rounded-md">
                    {stream.thumbnail ? (
                      ...
                      <AvatarFallback className="rounded-md bg-brand-gradient text-brand-foreground">
                  ...
                  {stream.status === "live" && (
                    <span className="absolute -top-1 -right-1 flex h-3 w-3">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-error/60 opacity-75"></span>
