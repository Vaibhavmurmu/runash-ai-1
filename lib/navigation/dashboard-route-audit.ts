...
export const dashboardRouteAuditEntries: readonly DashboardRouteAuditEntry[] = [
  ...
  { href: "/dashboard/chat", readiness: "ready", source: "shared", notes: "Legacy path redirects to /runashchat." },
  { href: "/dashboard/runash-chat", readiness: "ready", source: "shared", notes: "Legacy path redirects to /runashchat." },
  { href: "/chat", readiness: "ready", source: "shared", notes: "Legacy path redirects to /runashchat." },
  { href: "/runash-chat", readiness: "ready", source: "shared", notes: "Legacy path redirects to /runashchat." },
  { href: "/editor", readiness: "ready", source: "sidebar", required: true },
  { href: "/dashboard/editor", readiness: "ready", source: "shared", notes: "Legacy path redirects to /editor." },
