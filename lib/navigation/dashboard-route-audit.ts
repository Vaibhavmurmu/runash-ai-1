...
export const dashboardRouteAuditEntries: readonly DashboardRouteAuditEntry[] = [
  ...
  { href: "/dashboard/chat", readiness: "ready", source: "sidebar", required: true },
  { href: "/dashboard/runash-chat", readiness: "ready", source: "shared", notes: "Legacy path redirects to /dashboard/chat." },
  { href: "/chat", readiness: "ready", source: "shared", notes: "Legacy path redirects to /dashboard/chat." },
  { href: "/runash-chat", readiness: "ready", source: "shared", notes: "Legacy path redirects to /dashboard/chat." },
  { href: "/dashboard/editor", readiness: "ready", source: "sidebar", required: true },
