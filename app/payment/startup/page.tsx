...
import { ArrowRight, BarChart3, Link2, Receipt, Rocket, Wallet } from "lucide-react"
    ...
    <div className="container mx-auto px-4 py-8 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Built for fast onboarding with core payment features: links, payment collection, basic analytics, and
            account setup.
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            ...
            <p>• Collect a test payment intent</p>
            <p>• Track transaction trend and conversion</p>
          </CardContent>
        </Card>
